...
struct rectangle {
    ...
    {
        if (other.top_left.x < top_left.x)
            return false;
        if (other.top_left.x + other.size.w > top_left.x + size.w)
            return false;
        if (other.top_left.y < top_left.y)
            return false;
        if (other.top_left.y + other.size.h > top_left.y + size.h)
            return false;
...
{
    if (lhs.top_left.x + lhs.size.w < rhs.top_left.x)
        return false;
    if (rhs.top_left.x + rhs.size.w < lhs.top_left.x)
        return false;
    if (lhs.top_left.y + lhs.size.h < rhs.top_left.y)
        return false;
    if (rhs.top_left.y + rhs.size.h < lhs.top_left.y)
        return false;
